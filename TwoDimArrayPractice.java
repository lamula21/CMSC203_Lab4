	   ...
	   for ( int row = 0; row < intArray.length; row++ )
	    {
	          ...
	          if ( intArray[row][column] < flag ) {
	        	 flag = intArray[row][column] ;}
	          
	          animate( row, column, flag );  // needed to create visual feedback
	         
	    } 
	  
      return flag; // replace this line with your return statement
   }
	   ...
	   for ( int row = 0; row < intArray.length; row++ )
	    {
	        ...
	        { 
	          if ( intArray[row][column] == value ) {
	        	 counter++;}
	          animate( row, column, counter );  // needed to create visual feedback
	        } 
	    }
